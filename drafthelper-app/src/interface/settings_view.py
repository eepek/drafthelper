...
class SettingsView:
    ...
    def incorrect_value(self, id: int):
        if id == 1:
    ...
    def send_settings_values(self):
        ...
        self._interface.set_draft_position(self.__draft_position.get())
        self._interface.set_team_name(self.__name_entry.get())
        self._interface.set_league_size(self.__league_size.get())
